...
const Hero = () => {
  ...
  return (
    ...
    <div className='min-h-screen relative pt-25 px-3 md:px-16 bg-cover bg-center'>
...
<div className="md:flex gap-4 max-w-120 ">
          <button onClick={()=>router.push('/request-a-part')} className='w-full hover:bg-[linear-gradient(to_right,rgba(60,8,126)_0%,rgba(60,8,126,0.32)_100%)]
                      ...
                      md:px-6 px-4 py-2 md:py-3 mt-4 font-bold transition-all duration-300 rounded-full text-white border-[1px] border-[#4D2F8C] cursor-pointer'>
            Request a Part Now
          </button>
            <a href="#how-it-works" className='w-full'> 
            <button  className='w-full hover:bg-[linear-gradient(to_right,rgba(60,8,126)_0%,rgba(60,8,126,0.32)_100%)]
                      shadow-lg shadow-[rgba(60,8,126,0.8)]
