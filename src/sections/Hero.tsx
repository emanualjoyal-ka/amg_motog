...
const Hero = () => {
  ...
  return (
    ...
    <div ref={container} className='min-h-screen flex flex-col lg:flex-row relative pt-25 px-5 lg:px-16 bg-[radial-gradient(circle_at_top,rgba(77,47,140,0.35),transparent_50%)] '>
  ...
  pauseOnHover={false}
  disabled={false}
  className='title text-4xl cursor-default drop-shadow-[0_2px_1px_rgba(255,255,255,0.6)] text-center lg:text-left lg:w-140 md:text-6xl font-bold text-white'
/>

            
        <h2 className='subtitle md:text-xl text-center cursor-default lg:text-left text-white mt-2'>Quality bike parts tested in real workshops,</h2>
        <h2 className='subtitle md:text-xl text-center cursor-default lg:text-left text-white '> Reliable performance at honest prices.</h2>

<div className=" flex flex-col lg:flex-row gap-5 mt-4 w-[90%] lg:w-full">
           <button onClick={()=>router.push('/request-a-part')} className='btn relative w-full hover:bg-[linear-gradient(to_right,rgba(60,8,126)_0%,rgba(60,8,126,0.32)_100%)]
          ...
          <div className='absolute rounded-lg -z-1 animate-pulse shadow-[0_0_10px_10px_rgba(60,8,126,0.8)] bg-[#0C0B1D] inset-0 '>
            ...
            <a href="#how-it-works" className='btn w-full'> 
        ...
        <div className='hero flex items-center mb-5 md:mb-0 rounded-3xl animate-float drop-shadow-[0_20px_25px_rgba(0,0,0,0.5)] justify-center'>
