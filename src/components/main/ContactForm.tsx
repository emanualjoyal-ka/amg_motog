...
const Form = () => {
  ...
  return (
    <>
      <form onSubmit={handleSubmit} className=' md:col-span-2  p-5 md:p-8 bg-white/5 border border-white/10 backdrop-blur-md rounded-2xl'>
          ...
          <label htmlFor='name' className='text-gray-300 text-sm tracking-wide block pt-5'>Name</label>
          ...
          <label htmlFor='email' className='text-gray-300 text-sm tracking-wide block pt-5'>Email</label>
          ...
          <label htmlFor='subject' className='text-gray-300 text-sm tracking-wide block pt-5'>Subject</label>
          ...
          <label htmlFor='message' className='text-gray-300 text-sm tracking-wide block pt-5'>Message</label>
