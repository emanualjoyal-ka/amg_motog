...
const FollowUs = () => {
  return (
    <>
      <div>
        <p className="text-white font-semibold mb-3 cursor-default tracking-wide">Follow Us</p>
        <div className="flex gap-5 mt-5 md:mt-4">
          ...
          <div className="h-12 w-12 bg-[#1E2939] items-center flex justify-center rounded-full hover:bg-[#272080] transition-hover duration-300 cursor-pointer">
