  ...
  return (
    ...
    <div className="border-[#26345D] mt-5 border bg-[#303030]/20  backdrop-blur-md p-5 md:p-8 rounded-lg">
           ...
           <div className="h-12 w-12 md:h-15 md:w-15 bg-green-500 flex items-center justify-center rounded-full hover:scale-110 transition-hover duration-300 cursor-pointer">
            ...
            <div className="w-12 h-12 md:h-15 md:w-15 bg-[linear-gradient(45deg,#f09433_0%,#e6683c_25%,#dc2743_50%,#cc2397_75%,#323232_100%)] items-center flex justify-center rounded-full hover:scale-110 transition-hover duration-300 cursor-pointer">
            <div className="w-6 md:w-9 text-white">
              <svg
                className="w-full h-full"
                viewBox="0 0 24 24"
