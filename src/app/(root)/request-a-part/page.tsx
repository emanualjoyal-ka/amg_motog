...
const page = () => {
  return (
    <div className='pt-15 text-white bg-[#0C0B1D] md:pt-30 pb-8 md:pb-20 px-3 md:px-140 min-h-screen bg-[radial-gradient(circle_at_top,rgba(77,47,140,0.35),transparent_50%)]'>
